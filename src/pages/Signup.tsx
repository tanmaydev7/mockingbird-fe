...
const Signup = () => {
  ...
  const handleGoogleSignup = () => {
    // TODO: Implement Google SSO signup
  }
              ...
              <div className="w-full">
                <div className="bg-black/40 rounded-lg p-6 space-y-4">
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    <span className="text-white/90 font-medium">Instant Mock Generation</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    <span className="text-white/90 font-medium">Custom Response Scenarios</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    <span className="text-white/90 font-medium">Realistic Data Types</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>
                    <span className="text-white/90 font-medium">Zero Backend Setup</span>
                  </div>
                </div>
              </div>
            </div>
